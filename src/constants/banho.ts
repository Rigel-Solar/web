...
export const banho: Banho = {
  ...
  inspectionItems: [
    ...
    {
      quantity: null,
      description: "Distance from the boiler to the hot water distribution connection",
    },
    {
      quantity: "01",
      description: "1\" valve at the water tank outlet, exclusively for boiler supply",
    },
    {
      quantity: "01",
      description: "1\" valve on the hot water pipe approximately 1 meter from the boiler",
    },
    {
      quantity: "01",
